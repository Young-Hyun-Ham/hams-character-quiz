    ...
    <main className="board-shell">
      ...
      <section className="board-container">
        <div className="board-heading">
          <div>
            <span className="board-kicker">QUESTION BOARD</span>
            <h1>문의하기</h1>
            <p>궁금한 점이나 전하고 싶은 이야기를 남겨 주세요.</p>
          </div>
          <Link className="primary-board-button" href="/inquiries/new">
            문의 작성
          </Link>
        </div>
            ...
            {inquiries.map((inquiry) => (
              ...
              >
                ...
                <div className="inquiry-meta">
                  ...
                  <span>댓글 {inquiry.commentCount}</span>
                </div>
              </Link>
            ))}
          </div>
